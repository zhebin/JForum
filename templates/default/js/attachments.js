...
<#if attachmentsEnabled>
	var template = "<div id='attach_#counter#'><table width='100%' class='gensmall' style=table-layout:auto><tr><td style=border-top:0px;>${I18n.getMessage("Attachments.filename")}</td>";
	template += "<td style=border-top:0px;><input type='file' size='50' name='file_#counter#'></td></tr>";
	template += "<tr><td style=border-top:0px;>${I18n.getMessage("Attachments.description")}</td>";
	template += "<td style=border-top:0px;><input type='text' name='comment_#counter#' size='50'>";
